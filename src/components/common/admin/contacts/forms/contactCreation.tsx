...
import { useAddContact } from '@/lib/client/useContact';
...
export default function ContactCreationForm({
  ...
  const addContact = useAddContact({ churchId: contacts?.churchId ?? '' });
  ...
  async function onSubmit(data: z.infer<typeof schema>) {
    // if any of the fields are "" set them to undefined
    ...
    try {
      await addContact.mutateAsync({ contact: data });
    ...
    <Form {...form}>
      ...
      >
            ...
            <FormItem>
              ...
              <FormControl>
                <SelectComponent
                  ...
                  placeholder=""
                  shouldVariedOptions={true}
                  options={['INFA', 'CHILD', 'TEEN', 'ADULT', 'ELDER']}
                  variedOptions={[
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          >
            {addContact.isPending ? <LoadingCircle /> : 'Add Contact'}
          </button>
        </div>
      </form>
    </Form>
